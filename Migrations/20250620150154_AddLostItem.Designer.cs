...
namespace WaslAlkhair.Api.Migrations
{
    ...
    [Migration("20250620150154_AddLostItem")]
    partial class AddLostItem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WaslAlkhair.Api.Models.AssistanceType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("51b200aa-0b5e-4fe4-b03c-0f94030ea3d2"),
                            Name = "طبية"
                        },
                        new
                        {
                            Id = new Guid("fde026c4-ffad-407a-8d94-40cebf27eb3d"),
                            Name = "غذائية"
                        },
                        new
                        {
                            Id = new Guid("348d9ef7-a628-4e41-ab12-1c409fbc1f2b"),
                            Name = "بيطرية"
                        },
                        new
                        {
                            Id = new Guid("0c5251ff-cd96-4cae-8985-141ee43977d2"),
                            Name = "تعليمية"
                        },
                        new
                        {
                            Id = new Guid("993110ad-54c4-4822-8de0-715f0e715983"),
                            Name = "مالية"
                        },
                        new
                        {
                            Id = new Guid("9565e523-e447-4808-b939-3c2f00a106c6"),
                            Name = "سكنية"
                        },
                        new
                        {
                            Id = new Guid("9cfceaf8-8f67-45e2-8d91-725051654bda"),
                            Name = "بيئية"
                        },
                        new
                        {
                            Id = new Guid("acacc394-e62a-46b0-8ab3-768bee7d72d2"),
                            Name = "ذوي الاحتياجات الخاصة"
                        },
                        new
                        {
                            Id = new Guid("3a2baf09-e4a4-40fa-be34-6061a89ccfe0"),
                            Name = "طارئة وإغاثية"
                        });
                });
            ...
            modelBuilder.Entity("WaslAlkhair.Api.Models.LostItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WaslAlkhair.Api.Models.LostItem", b =>
                {
                    b.HasOne("WaslAlkhair.Api.Models.AppUser", "User")
                        .WithMany("LostItems")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
